...
class Login extends CI_Controller {
	...
	public function enviar_mail($data){
		...
		<p>
		Hola <strong>'.$nombre.'</strong>, tu participación es muy importante para nosotros, por esto te agradecemos el haberte registrado. </p>

		<p>Tu contraseña ha sido restaurada a su version anterior: '.$data["pass"].'
		</p>

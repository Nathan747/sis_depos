        ...
        <div class="contenedor-modo-donar">
          <div class="contenedor-medio-donacion contenedor-mercado-pago">
            ...
            <div class="menu-mercado-pago">
              ...
              <a id="boton-8" style="display: none" name="MP-Checkout" mp-mode="modal" href="<?php echo $preference['response']['init_point'] ?>" onreturn="execute_my_onreturn" target="modal">$1</a>

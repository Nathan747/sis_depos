    ...
    <div class="col-md-3">
      <div class="col-md-12 first" align="left">
        ...
        if (strpos($foto, 'https://') > -1) {
            ?>
            <img class="photo img-responsive img-portfolio img-hover" src="<?php echo $foto;?>">
            <?php
        }else{
            ?>
...
<div class="control-group form-group padre-mapa-modificar">
    <label>Ubicación:</label>
    <div id="mapa_modificar"></div>
</div>
</div>
